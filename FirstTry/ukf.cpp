...
void UKF::ProcessMeasurement(MeasurementPackage meas_package) {
  ...
  */
  ...
  MatrixXd Zsig_radar = MatrixXd(dim_radar_measurement_, 2*n_aug_+1);
  ...
  VectorXd z_pred_radar = VectorXd(dim_radar_measurement_);
  //create measurement covariance matrix for radar
  MatrixXd S_radar = MatrixXd(dim_radar_measurement_, dim_radar_measurement_);
  //create mean predicted measurement for lidar
  VectorXd z_pred_laser = VectorXd(dim_laser_measurement_);
  //create measurement covariance matrix for lidar
  MatrixXd S_laser = MatrixXd(dim_laser_measurement_, dim_laser_measurement_);
